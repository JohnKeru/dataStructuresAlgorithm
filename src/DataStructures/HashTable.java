...
/**
 * This file defines a HashTable class. Keys and values in the table are of type
 * String. Keys cannot be null. The default constructor creates a table that
 * initially has 64 locations, but a different initial size can be specified as
 * a parameter to the constructor. The table increases in size if it becomes
 * more than 3/4 full; to help implement this, a count of the number of items in
 * the hash table is kept in an instance variable.
 */
public class HashTable {
	...
	/**
	 * Create a hash table with a specified initial size. Precondition: initalSize >
	 * 0.
	 */
	...
	/**
	 * This method is NOT part of the usual interface for a hash table. It is here
	 * only to be used for testing purposes, and should be removed before the class
	 * is released for general use. This lists the (key,value) pairs in each
